...
$MERGER = "$ROOT\merge_tuktuk_to_data.py"
$OUTPUT = "$ROOT\screpte\tuktukhd\tuktuk\foreign.json"

Write-Host "========== TukTuk Foreign Films ==========" -ForegroundColor Cyan
...
Write-Host 'git add -A && git commit -m "تحديث أفلام أجنبية TukTuk" && git push' -ForegroundColor White
