...
HINDI_JSON = r"screpte\tuktukhd\tuktuk\hindi_movies.json"
DATA_FILE = r"data-hindi.js"

if not os.path.exists(DATA_FILE):
    print(f'[data-hindi.js] Not found — creating new file')
    content = '// أفلام هندية — 0 عنصر\nconst cd_hindi = [];'
else:
